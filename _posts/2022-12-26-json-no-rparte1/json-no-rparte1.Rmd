...
description: |
  Este é o primeiro tutorial de dois sobre JSON no R. Nesta primeira parte, mostro como usar o pacote `jsonlite` para converter de JSON para R e vice-versa. Na próxima postagem, trato de como trabalhar com JSON como JSON mesmo no R, sem convertê-lo para lista ou dataframe.
author:
